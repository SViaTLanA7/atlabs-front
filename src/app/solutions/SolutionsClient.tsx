...
export default function SolutionsClient() {
    ...
    return (
        <section className="container-1160 px-4 py-8">
            ...
            <textarea
                className="w-full h-[140px] rounded-[10px] bg-white text-[var(--text)] placeholder:text-[var(--muted)] px-3 py-2 outline-none resize-none border border-[var(--br)]"
            ...
            />
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            />
                            <span className="text-[13px] opacity-70">PNG, JPG, PDF, DOC — до 10 МБ</span>
                        </div>
                        ...
                        {files.length > 0 && (
                            <div className="mt-2 space-y-1">
                                {files.map((f) => (
                                    <div
                                        key={f.name + f.size}
                                        className="flex justify-between items-center bg-white rounded-lg px-3 py-2 text-[14px] border border-[var(--br)]"
                                    >
                    ...
                    <button
                        ...
                        disabled={submitting}
                        className="mt-4 btn-primary rounded-[10px] inline-flex items-center gap-2 disabled:opacity-60"
                    >
                        {submitting ? (
                            <>
                    ...
                    <div className="mt-2 text-sm opacity-70">
                        5 токенов ≈ 1 задача · Осталось: <span className="font-semibold">{tokens}</span>
                    </div>
                    ...
                    {submitting && (
                        <div className="mt-6 card p-4">
                            ...
                            <div className="mt-3 h-[100px] rounded-lg bg-gray-100 animate-pulse" />
                        </div>
                    )}
                ...
                <aside className="col-span-12 lg:col-span-4">
                    <div className="card p-4">
                        ...
                        <a className="mt-4 w-full btn-primary inline-flex justify-center rounded-[10px]" href="/pricing">
                            Перейти к тарифам
                        </a>
                    </div>
                </aside>
